...
const productImageController = async (req, res) => {
  ...
  const updateProductController = async (req, res) => {
    try {
      ...
      if (!image || image.size > 1048576) return res.status(400).send({ error: 'Image is required and should be less than 1MB' });
...
module.exports = { createProductController, getProductController,getUserProductsController, getSingleProductController, productImageController, deleteProductController, updateProductController };
