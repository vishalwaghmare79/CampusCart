...
function Header() {
  ...
  <div>
    <ul className="nav-links">
      ...
      <li className="nav-item">
        <NavLink to="/search" className="nav-item-a" activeClassName="active">
          <i className="nav-icon ri-search-line"></i>
          <span>Search</span>
        </NavLink>
      </li>
      <li className="nav-item">
  ...
  <NavLink to="/search" className="bottom-nav-link" activeClassName="active">
