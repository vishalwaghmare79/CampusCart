...
const Register = () => {
  ...
  return (
    <>
    <DynamicHelmet
    title="Register - Shopease E-Commerce"
    description="Create a new account on Shopease to start buying and selling products within the student community."
    keywords="register, signup, create account, Shopease"
    />
